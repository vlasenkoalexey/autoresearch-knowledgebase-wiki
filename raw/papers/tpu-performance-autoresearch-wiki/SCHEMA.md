...
tpu_performance_autoresearch_wiki/     ← project root (agent CWD)
  ...
  wiki/
    ...
    kernel_experiments/                ← kernel families (kernel-as-model): program.md kernel root
      ...
      e.g. afm_pt_moe_autoresearch_optimization/jax/2026-05-12-v006-…-bf16-compute.md
...
A serious optimization project on a specific model architecture (e.g. AFM PT MoE) lives in its **own private repo**, derived as a fork of this template:
...
```yaml
type: model
architecture: <slug>                          # e.g. afm-pt-moe
...
```yaml
model: <model-slug>                           # the model lane page, e.g. afm-pt-moe-jax
...
head -30 wiki/experiments/afm_pt_moe_autoresearch_optimization/jax/log.md
```
...
| Model pages | `models/<architecture>-<lane>.md` | `afm-pt-moe-jax.md`, `afm-pt-moe-torchax.md`, `afm-pt-moe-tpu.md` |
...
| Experiment pages (model) | `wiki/experiments/<model>_autoresearch_optimization/<lane>/<YYYY-MM-DD>-v<NNN>-<slug>.md` | `afm_pt_moe_autoresearch_optimization/jax/2026-05-12-v006-afm-pt-moe-3b-v6e-16-bf16-compute.md` |
