...
|---|---|---|
| `exp_slug` | `afm-pt-moe-jax-v391m-tokamax-ce` | YES |
| `index_path` | `/mnt/disks/persist/.../wiki/profile-analyzer-index.md` (ABSOLUTE) | YES |
| `experiment_page_path` | `/mnt/disks/persist/.../wiki/experiments/afm_pt_moe_autoresearch_optimization/jax/2026-05-29-v391m-tokamax-ce.md` (ABSOLUTE) | YES |
