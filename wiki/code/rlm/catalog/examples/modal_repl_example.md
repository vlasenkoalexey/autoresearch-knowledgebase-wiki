---
title: 'Module: examples/modal_repl_example.py'
type: catalog
provenance: extracted
module: examples/modal_repl_example.py
status: fresh
symbol_base: scip-python python rlm 0.0.0 `examples.modal_repl_example`/
symbols:
  main: main().
...
---
# Module: [`examples/modal_repl_example.py`](../../../../../raw/code/rlm/examples/modal_repl_example.py)

## Classes
### `MockLM`  ·  implements/extends BaseLM
- def: [`examples/modal_repl_example.py:13`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L13)
- doc: Simple mock LM that echoes prompts.
- signature: `class MockLM(BaseLM):`
- members:
  - `acompletion(self, prompt)` — [`L22`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L22)
  - `completion(self, prompt)` — [`L19`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L19)
  - `get_last_usage(self)` — [`L34`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L34)
  - `get_usage_summary(self)` — [`L25`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L25)
- protocol/private: `__init__`[`L16`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L16)
...
## Functions
- `main()` — [`L38`](../../../../../raw/code/rlm/examples/modal_repl_example.py#L38)
